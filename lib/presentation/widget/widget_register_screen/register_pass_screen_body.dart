...
class RegisterPasswordScreenBody extends StatelessWidget {
   RegisterPasswordScreenBody({super.key});
            ...
            children:[
              ...
              CustomButtonRegisterWidget(
                  ...
                  onPressed: ()
                  {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context)=>const RegisterConfirmPasswordScreen()),
                    );
                  },
